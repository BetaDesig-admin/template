...
do_action( 'woocommerce_before_edit_account_form' ); ?>
    <h3 class="sharedTitle"><?= get_field( 'account-info-heading', get_the_ID() ) ?></h3>
    <form class="woocommerce-EditAccountForm edit-account" action=""
        ...
        <h3 class="sharedTitle"><?php esc_html_e( 'Password change', 'woocommerce' ); ?></h3>

        <div class="sharedForm newPassword">
            <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
        ...
        <p>
            ...
            <button type="submit"
                    class="link <?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>"
