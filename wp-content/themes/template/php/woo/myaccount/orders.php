...
do_action( 'woocommerce_before_account_orders', $has_orders ); ?>
    ...
    <h3 class="sharedTitle"><?= get_field('account-orders-heading', get_the_ID()) ?></h3>
...
<?php else : ?>
    <div class=" woocommerce-message--info woocommerce-Message woocommerce-Message--info">
        ...
        <p><a class="link" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>"><?php esc_html_e( 'Browse products', 'woocommerce' ); ?></a></p>
    </div>
<?php endif; ?>
